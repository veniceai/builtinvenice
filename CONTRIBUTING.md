...
<!-- Media submissions temporarily hidden — restore " / Media" in the heading
and `content/media/` in the paragraph to re-enable. -->
## Adding a Cookbook

Add a file under `content/cookbooks/` following an existing entry. Keep descriptions plain and short.
...
- Community content (cookbooks and builder interviews).
