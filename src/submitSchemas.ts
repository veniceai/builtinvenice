...
export const submissionTypes: SubmissionType[] = [
  {
    key: 'project',
    label: 'Project',
    blurb: 'Website, GitHub repo, or X account.',
    template: 'submit-project.yml',
    titlePrefix: '[Project] ',
    titleField: 'project-name',
    fields: [
      { id: 'project-name', label: 'Project name', type: 'text', required: true, placeholder: 'e.g. Your Project, @yourhandle, project-name' },
      {
        id: PROJECT_TYPE,
        label: 'Project type',
        type: 'select',
        required: true,
        options: ['Website', 'GitHub Repo', 'X Account'],
      },
      ...
      { id: 'submitted-by', label: 'Your name / handle', type: 'text', placeholder: 'e.g. @yourhandle' },

      // GitHub Repo fields
      { id: 'github-owner', label: 'GitHub owner', type: 'text', placeholder: 'e.g. owner-name', showWhen: f => f[PROJECT_TYPE] === 'GitHub Repo' },
      { id: 'github-repo', label: 'GitHub repo name', type: 'text', placeholder: 'e.g. repo-name', showWhen: f => f[PROJECT_TYPE] === 'GitHub Repo' },
      ...
      // X Account fields
      { id: 'x-handle', label: 'X handle', type: 'text', placeholder: 'yourhandle', description: 'Without the @.', showWhen: f => f[PROJECT_TYPE] === 'X Account' },
...

      {
        ...
        type: 'textarea',
        description: 'One per line, kind: url. Kinds: x, github, website, farcaster, warpcast, instagram, telegram, discord, youtube, tiktok.',
  ...
  },
  {
    ...
    fields: [
      { id: 'cookbook-title', label: 'Title', type: 'text', required: true, placeholder: 'e.g. Building a chat app with the Venice API' },
      ...
      { id: 'author', label: 'Author handle', type: 'text', required: true, placeholder: 'e.g. yourhandle' },
