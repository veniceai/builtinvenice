...
export const submissionTypes: SubmissionType[] = [
  ...
  },
  {
    ...
    titleField: 'title',
    fields: [
      { id: 'title', label: 'Title', type: 'text', required: true, placeholder: 'e.g. Streaming chat completions with the Venice API' },
      { id: 'url', label: 'URL', type: 'text', required: true, placeholder: 'https://github.com/owner/repo/blob/main/cookbook/recipe.md' },
  ...
  },
  {
    ...
    titleField: 'title',
    fields: [
      { id: 'title', label: 'Event name', type: 'text', required: true, placeholder: 'e.g. Venice Private-AI Hackathon' },
      { id: 'url', label: 'URL', type: 'text', required: true, placeholder: 'https://lu.ma/your-event' },
  ...
  },
  {
    ...
    titleField: 'title',
    fields: [
      { id: 'title', label: 'Title', type: 'text', required: true, placeholder: 'e.g. openvenice running chat, image, and audio in one tab' },
      { id: 'url', label: 'Demo URL', type: 'text', required: true, placeholder: 'https://x.com/yourhandle/status/…  /  https://loom.com/…  /  https://…', description: 'Link to where the demo lives — X post, Loom, asciinema, gallery image.' },
