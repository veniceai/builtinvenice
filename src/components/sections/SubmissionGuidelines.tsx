    ...
    <section className="hero-section guidelines-section">
      ...
      <div className="guidelines-body">
        <p className="hero-subtitle">
          Built in Venice is for projects, tools, guides, and experiments that help people discover what can be built with Venice.
        </p>
        ...
        <p className="hero-subtitle">
          All submissions are reviewed before publishing. Listing on Built in Venice does not imply endorsement by Venice AI.
        </p>
      </div>
    </section>
  );
